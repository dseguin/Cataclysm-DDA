...
S_API void *S_CALLTYPE SteamInternal_FindOrCreateUserInterface( HSteamUser hSteamUser,
        const char *pszVersion );
S_API void *S_CALLTYPE SteamInternal_FindOrCreateGameServerInterface( HSteamUser hSteamUser,
        const char *pszVersion );
...
class CSteamAPIContext
{
    public:
        ...
        inline bool
        Init(); // NOTE: This is defined in steam_api.h, to avoid this file having to include everything
