...
S_API bool S_CALLTYPE SteamAPI_ManualDispatch_GetNextCallback( HSteamPipe hSteamPipe,
...
S_API bool S_CALLTYPE SteamAPI_ManualDispatch_GetAPICallResult( HSteamPipe hSteamPipe,
        SteamAPICall_t hSteamAPICall, void *pCallback, int cubCallback, int iCallbackExpected,
        bool *pbFailed );
